...
//  MusicPlayer
//
//  Created by Mohamed Fadul on 1/25/21.
...
class PlayerViewController: UIViewController {
   ...
   private let songNameLabel: UILabel = {
    ...
    override func viewDidLayoutSubviews() {
        ...
        func configure() {
            ...
            do {
                ...
                timer = Timer.scheduledTimer(timeInterval: 1, target: self, selector: #selector(songIsPlaying), userInfo: nil, repeats: true)
            }
            catch {
            ...
            // slider 2
             slider2 = UISlider(frame: CGRect(x: 20,
            ...
            slider2.addTarget(self, action: #selector(didSlideSlider2(_:)), for: .valueChanged)
            holder.addSubview(slider2)
    ...
    @objc func songIsPlaying() {
        let value = player?.currentTime ?? 0
        slider2.setValue(Float(value), animated: true)
    ...
    @objc func didSlideSlider(_ slider: UISlider) {
        ...
        player?.volume = value
        print(2)
        // adjusting player volume
    }
    
    @objc func didSlideSlider2(_ slider: UISlider) {
        let value = slider.value
